...
<link rel="stylesheet" type="text/css" href="styleSheet-rate.css"/>
<title>Review</title>
</head>
<body>
...
<form method="POST" class="rateform-box" action = "submitaReviews.php">
	<br>
	<h3>Rating Service</h3>
	<br>
	
				<input class="input-fild" type="text" name="first-name" id="first-name" placeholder="Enter First Name"></input><br><br>
				
				<input class="input-fild" type="text" name="last-name" id="last-name" placeholder="Enter Last Name"></input><br><br>
	 
	
	<label class="Name-Tag" for="name"><b>Overall Service</b></label>
  ...
  <label>
	...
	<label method="POST" class="Name-Tag"  for="name" required><b>Comment</b></label><br>
	<!--<input class="input-fild" type="text" name="comment" id="first-name" placeholder="Enter First Name"></input>-->
...
<table class="T1"  width="100%">
	...
	<tr> 
		<th>
			...
			<a href="rate.html"><img src="Images/ICONS/rw2.png" width="180" height="60"></a>
